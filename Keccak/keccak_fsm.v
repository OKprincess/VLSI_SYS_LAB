...
*/
    ...
    always @(*) begin
            case (c_state)
                ...
                S_ABSB_KECCAK   : keccak_istate_valid = !keccak_ostate_valid;
                S_PADD_KECCAK   : keccak_istate_valid = !keccak_ostate_valid; // nstate=s_padd_keccak
                S_SQUZ          : keccak_istate_valid = (block_last && obytes_len>block_size); // n_state=s_squz_keccak
                S_SQUZ_KECCAK   : keccak_istate_valid = !keccak_ostate;
                default         : keccak_istate_valid = 0;
            endcase
   end
